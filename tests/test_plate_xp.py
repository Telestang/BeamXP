...
class PlateXpTests(unittest.TestCase):
    ...
    def test_cloned_rear_material_matches_the_plate_it_was_cloned_from(self) -> None:
        ...
        # ...except the maps a custom format does not bind. Tested in game: the
        # base and -specular tags bind, -normal and -metallic do not, and
        # referencing either leaves the rear shading wrong.
