...
from beamxp.core.cache import (
    ...
    PART_TABLE_CACHE_VERSION,
    clear_part_table_caches,
    clear_parts_cache,
    clear_variant_hands_cache,
    context_cache_fingerprint,
    context_cache_path,
    context_fingerprint_hash,
    load_cached_mesh_numbering,
    load_cached_mesh_roles,
    load_cached_part_ids,
    load_cached_vehicle_context,
    mesh_numbering_cache_key,
    mesh_numbering_cache_path,
    mesh_roles_cache_path,
    part_table_cache_fingerprint,
    parts_cache_path,
    save_cached_mesh_numbering,
    save_cached_mesh_roles,
...
def selected_mesh_transform_instances_for_config(
    ...
    """
    return selected_mesh_transform_instances_for_selection(
        context,
        selected_parts_for_config(context, config_name),
    )


def selected_mesh_transform_instances_for_selection(
    context: VehicleContext,
    selected: dict[str, object],
) -> list[MeshTransformInstance]:
    """Renderable mesh placements for an already-resolved part tree."""
    populated = node_groups_for_selection(
        selected,
